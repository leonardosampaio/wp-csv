...
if(!function_exists('csv_meta_box_add'))
{
    function csv_meta_box_add()
    {
        global $post;
        if (isset($post) && $post->post_status != 'draft')
        {
            return;
        }
...
if(!function_exists('csv_meta_box_html'))
{
...
if(!function_exists('hook_transition_post_status'))
{
...
if(!function_exists('csv_admin_notice'))
{
    function csv_admin_notice() {
...
if(!function_exists('add_post_multipart_form_data'))
{
...
add_action('admin_notices', 'csv_admin_notice');
